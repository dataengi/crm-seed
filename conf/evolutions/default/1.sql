...
create table "contacts" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"contacts_book_id" BIGINT NOT NULL,"create_date" BIGINT NOT NULL,"skype_id" VARCHAR,"fax" VARCHAR,"company" VARCHAR,"job_position" VARCHAR,"address_id" BIGINT,"time_zone" VARCHAR,"language" VARCHAR,"contact_type" VARCHAR,"note" VARCHAR,"advertiser" BIGINT);
create table "phone_contact" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"type" VARCHAR NOT NULL,"phone" VARCHAR NOT NULL,"contact_id" BIGINT NOT NULL);
create table "email_contact" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"type" VARCHAR NOT NULL,"email" VARCHAR NOT NULL,"contact_id" BIGINT NOT NULL);
...
create table "recover_password_info" ("email" VARCHAR NOT NULL,"host" VARCHAR NOT NULL,"user_id" BIGINT NOT NULL,"expired_date" BIGINT NOT NULL,"recover_id" VARCHAR NOT NULL,"status" VARCHAR NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
create table "users" ("login_info_id" BIGINT NOT NULL,"company_id" BIGINT NOT NULL,"role_id" BIGINT NOT NULL,"state" VARCHAR NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
create table "companies" ("name" VARCHAR NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
create table "permissions" ("action" VARCHAR NOT NULL,"permission_state" VARCHAR NOT NULL,"role_id" BIGINT NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
create table "roles" ("name" VARCHAR NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
create table "invite" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"email" VARCHAR NOT NULL,"roleId" BIGINT NOT NULL,"companyId" BIGINT NOT NULL,"expiredDate" BIGINT NOT NULL,"status" VARCHAR NOT NULL,"hash" VARCHAR NOT NULL,"invitedBy" BIGINT NOT NULL);
